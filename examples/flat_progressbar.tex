...
\usepackage[
    templatefile="none",  % We do not want this plotted, invalid name ok (just a warning)
    leftpadding=0.55\paperwidth,  % Fiducial
    rightpadding=0.45\paperwidth,  % Choose so that \leftpadding + \rightpadding = \paperwidth
]{../gwbar}
